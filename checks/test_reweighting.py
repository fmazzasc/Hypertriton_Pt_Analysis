...
df_rec = uproot.open("/data/fmazzasc/PbPb_2body/SignalTable_20g7_flat_pt.root")["SignalTable"].arrays(library="pd").query("abs(Rapidity)<0.5 and pt>0")
df_gen = uproot.open("/data/fmazzasc/PbPb_2body/SignalTable_20g7_flat_pt.root")["SignalTable"].arrays(library="pd").query("abs(gRapidity)<0.5")
...
# df_rec = uproot.open("/data/fmazzasc/PbPb_2body/MC_tables/SignalTable_bw_0_10.root")["SignalTable"].arrays(library="pd").query("abs(Rapidity)<0.5 and pt>0")
